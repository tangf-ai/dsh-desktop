 ...
 * Web shape only. The source-preview Electron shell supervises this carrier
 * on loopback; an installable desktop carrier can replace it with file:// and
 * IPC. This package never prints: the URL line belongs to the shell.
 */
